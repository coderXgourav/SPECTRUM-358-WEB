...
const SecuritySettings = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-6 py-4">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <div className="relative w-full sm:w-auto">
              ...
              <input
                type="text"
                placeholder="Search"
                className="pl-10 pr-4 py-2 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:bg-white transition-all w-full sm:w-48 lg:w-64 text-xs sm:text-sm"
              />
            </div>
            <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors relative">
              <Bell className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600" />
            </button>
            <button className="flex items-center space-x-1 sm:space-x-2 p-2 hover:bg-gray-100 rounded-lg transition-colors">
              <div className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 rounded-full bg-gray-300 flex items-center justify-center">
                <span className="text-xs sm:text-sm font-medium text-gray-600">MH</span>
              </div>
