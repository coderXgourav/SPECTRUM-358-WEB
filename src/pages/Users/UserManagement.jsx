          ...
          <div className="p-4 sm:p-6 border-b">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600 mt-1 poppins-regular">
                  Manage your team members and their account permissions here.
                </p>
              </div>
              <button
                onClick={() => setShowAddUserModal(true)}
                className="flex items-center px-3 sm:px-4 py-2 bg-gradient-to-r from-[#E5B700] to-[#DE8806] text-white rounded-lg text-xs sm:text-sm font-medium poppins-medium hover:opacity-90 transition-opacity mt-2 sm:mt-0"
              >
                  ...
                  <tr key={user.id} className="hover:bg-gray-50">
                    <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div
                          className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-medium ${getAvatarColor(
                            index
                          )}`}
                        >
